...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\UAQi_proyecto\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\UAQi_proyecto\\public\\storage','logging.default',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','blade-heroicons.prefix',
'blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','blade-icons.sets','blade-icons.class',
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','filament.broadcasting',
...
'filament.admin.resources.appointment-products.index','filament.admin.resources.appointment-products.create','filament.admin.resources.appointment-products.edit','filament.admin.resources.appointments.index','filament.admin.resources.appointments.create',
'filament.admin.resources.appointments.edit','filament.admin.resources.medical-notes.index','filament.admin.resources.medical-notes.create','filament.admin.resources.medical-notes.edit','filament.admin.resources.pets.index',
'filament.admin.resources.pets.create','filament.admin.resources.pets.edit','filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit',
'filament.admin.resources.roles.index','filament.admin.resources.roles.create','filament.admin.resources.roles.edit','filament.admin.resources.user-profiles.index','filament.admin.resources.user-profiles.create',
'filament.admin.resources.user-profiles.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','sanctum.csrf-cookie',
'livewire.update','livewire.upload-file','livewire.preview-file',
'pets.index','pets.store','pets.show','pets.update','pets.destroy',
'appointments.index','appointments.store','appointments.show','appointments.update','appointments.destroy','storage.local',);
